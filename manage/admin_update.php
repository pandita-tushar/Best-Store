                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE admin SET name='$a_name', type='$a_type', mobile='$a_mobile', mail='$a_mail' WHERE aid = $aid ";
                            ...
                            ?>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class=" col-md-6 mt-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="admin-name" value="<?php echo $row['name']; ?>">
                                    </div>
                                    <div class="col-md-6 mt-3 mb-3">
                                        <label for="" class="form-label">Mobile</label>
                                        <input type="text" class="form-control" name="admin-mobile" value="<?php echo $row['mobile']; ?>">
                                    </div>
                                    <div class="col-md-6 mt-3 mb-3">
                                        <label for="" class="form-label">Mail</label>
                                        <input type="email" class="form-control" name="admin-mail" value="<?php echo $row['mail']; ?>">
                                    </div>
                                    <!-- <div class="col-md-6 mt-3 mb-3">
