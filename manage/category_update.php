                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE category SET name='$cat_name' WHERE cat_id = $cat_id ";
                                ...
                                <form class="row g-3" method="post" action="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="cat_name" name="cat_name" value="<?php echo $row['name'] ?>" required>
                                    </div>
