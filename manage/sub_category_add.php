                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "INSERT INTO sub_category (s_name, s_status, cat_id) VALUES('$sub_name', '$sub_status', '$cat_id' ) ";

                                if (mysqli_query($conn, $sql)) {
                                    $msg = "Sub-Category created successfully";
                                    $url = "product_category.php?msg=$msg";
                                    gotopage($url);
                                } else {
                            ...
                            ?>
                                ...
                                <form class="row g-3 mt-3" method="post" action="">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="sub_name" name="sub-name" required>
                                    </div>
