        ...
        <div class="container">
            <div class="col-md-4 products-left">
                ...
                <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
                    <a href="single.html"><img src="assets/images/29.jpg" alt=" " class="img-responsive" /></a>
            ...
            <?php
            $pid = $_GET['pid'];
            $sql = "SELECT * FROM product_master LEFT JOIN stock_purchase ON product_master.pid = stock_purchase.pid WHERE product_master.pid = $pid AND p_status = '1'";
            ...
            <div class="col-md-8 single-right">
                <div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="manage/uploads/<?php echo $row['pic1'] ?>">
                                <div class="thumb-image"> <img src="manage/uploads/<?php echo $row['pic1'] ?>" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="manage/uploads/<?php echo $row['pic2'] ?>">
                                <div class="thumb-image"> <img src="manage/uploads/<?php echo $row['pic2'] ?>" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="manage/uploads/<?php echo $row['pic3'] ?>">
                                <div class="thumb-image"> <img src="manage/uploads/<?php echo $row['pic3'] ?>" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                        </ul>
                    </div>
                    <!-- flixslider -->
                ...
                <div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
                    ...
                    <h4> <span class="item_price">₹ <?php echo $row['cost'] ?> - ₹ <?php echo $row['cost'] + 1000 ?></span> </h4>
                    <div class="rating1">
                    ...
                    <div class="description">
                        ...
                        <p style="color: red;">Hurry!! only <?php echo $row['product_qty'] ?> of these left.</p>
                    </div>
                    ...
                    <form action=<?php echo "add-to-cart.php?pid=$pid&pcat_id=$pcat_id"; ?> method="post">
                        ...
                        <div class="occasion-cart">
                            <button type="submit" name="submit-c" class="item_add btn btn-primary">Add to cart</button>
                        </div>
                        <div class="occasional">
                        </div>
                        <div class="">
                            
                            <button class="btn btn-success" name="buy-now" role="button">Buy Now</button>
    ...
    <div class="single-related-products">
        <div class="container">
            ...
            <div class="new-collections-grids">
                ...
                $pcat_id = $_GET['pcat_id'];
                $gpid = $_GET['pid'];
                $sql = "SELECT * FROM product_master WHERE product_category = $pcat_id AND pid != $gpid AND p_status = '1' ORDER BY pid DESC LIMIT 4 ";
                $rs = mysqli_query($conn, $sql);
                    ...
                    <div class="col-md-3 new-collections-grid">
                        <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
                            <div class="new-collections-grid1-image">
                                <a href="single.html" class="product-image"><img src="manage/uploads/<?php echo $row['pic2']; ?>" alt=" " class="img-responsive"></a>
                            ...
                            <form action=<?php echo "add-to-cart.php?pid=$gpid&pcat_id=$pcat_id"; ?> method="post">
                                ...
                                <div class="new-collections-grid1-left simpleCart_shelfItem occasion-cart">
                                    <p><span class="item_price">₹ <?php echo $row['cost']; ?></span><button type="submit" name="submitt" class="item_add btn btn-outline-warning">Add to cart</button></p>
                                </div>
                            </form>
                        </div>
                    </div>
